...
val_path = project_path+'val\\vallog\\'
assert os.path.exists(data_path), data_path

parser = argparse.ArgumentParser(description="paramaters of system")

parser.add_argument('--epochs', type=int, default=200,#1300
                    help="training epoch")
...
parser.add_argument('--Bounds', type=dict,
                    default={10: 10e-2, 12: 10e-2, 14: 10e-2, 16: 10e-2,
                             11: 12e-2, 15: 10e-2, 19: 5e-2, 23: 1e-2,
                             18: 10e-2, 20: 10e-3, 22: 10e-3, 24: 10e-3,
                             26: 10e-3, 28: 10e-3, 30: 10e-3},
...
parser.add_argument(('--val_seed'), type = int, default= 50, #42
                    help ="seed of generate training data ")
parser.add_argument('--NumK', type=int, default=5,
                    help="transmission times")
parser.add_argument('--NumN', type=int, default=4,
                    help="nodes number")
